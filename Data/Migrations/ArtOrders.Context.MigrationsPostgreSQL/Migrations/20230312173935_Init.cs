    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_identity_roles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_role_claims_user_identity_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "user_identity_roles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_role_owners_user_identity_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "user_identity_roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
